...
raxmlHPC -m PROTGAMMAGTR -p 12345 -s Bumble_Honey_bees_proteins/Gene_family_1058_parsed.multifasta -n ML_wo_bootstrap_Gene_family_1058_parsed.out

raxmlHPC -m PROTGAMMAGTR -p 12345 -s Bumble_Honey_bees_proteins/Gene_family_991_parsed.multifasta -n ML_wo_bootstrap_Gene_family_991_parsed.out

raxmlHPC -m PROTGAMMAGTR -p 12345 -s Bumble_Honey_bees_proteins/Gene_family_1099_parsed.multifasta -n ML_wo_bootstrap_Gene_family_1099_parsed.out

raxmlHPC -m PROTGAMMAGTR -p 12345 -s Bumble_Honey_bees_proteins/Gene_family_1048_parsed.multifasta -n ML_wo_bootstrap_Gene_family_1048_parsed.out

raxmlHPC -m PROTGAMMAGTR -p 12345 -s Bumble_bees_proteins/Gene_family_1674_parsed.multifasta -n ML_wo_bootstrap_Gene_family_1674_parsed.out
